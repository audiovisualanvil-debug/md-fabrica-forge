      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
        {steps.map((s, i) => (
          <div key={s.num} className="text-center relative">
            <span className="font-heading text-7xl md:text-8xl font-black text-primary/15 leading-none">
              {s.num}
            </span>
            <h3 className="font-heading text-xl font-bold text-foreground uppercase -mt-4 mb-2">
              {s.title}
            </h3>
